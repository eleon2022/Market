...
PRODUCTS = {
    ...
    "🏋️ فلاوين ثقيل": {"ku": "🏋️ فلاوین قەڵەو"}
}
...
async def show_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [["🛒 بيع", "🔍 شراء"], ["📦 عروضي", "📢 العروض"], ["♻️ ابدأ من جديد"]]
    if lang == "کوردی":
        keyboard = [["🛒 فرۆشتن", "🔍 کڕین"], ["📦 پیشکەشەکانم", "📢 پیشکەشەکان"], ["♻️ دەستپێکردنەوە"]]
        msg = "تکایە هەڵبژێرە:"
    else:
...
def main():
    ...
    app.add_handler(MessageHandler(filters.Regex("^(🔍 شراء|🔍 کڕین)$"), buy_start))
