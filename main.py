...
TEXTS = {
    'ar': {
        ...
        'sell_offers_button': "عروض البيع",
        'buy_requests_button': "طلبات الشراء",
    ...
    'ku': {
        ...
        'sell_offers_button': "پێشکەشەکانی فڕۆشتن",
        'buy_requests_button': "داواکاریەکانی کڕین",
...
PRODUCTS = [
    {'ar': 'بنزين', 'ku': 'بنزين'},
    {'ar': 'كاز فلاش', 'ku': 'كاز فلاش'},
    {'ar': 'كاز معمل', 'ku': 'كاز معمل'},
    {'ar': 'نافتا', 'ku': 'نافتا'},
    {'ar': 'دهن معمل', 'ku': 'دهن معمل'},
    {'ar': 'فلاوين', 'ku': 'فلاوين'},
    {'ar': 'فلاوين مواصفات', 'ku': 'فلاوين مواصفات'},
    {'ar': 'نفط خام', 'ku': 'نفط خام'}
]
